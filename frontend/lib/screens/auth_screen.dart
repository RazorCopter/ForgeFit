...
// ─────────────────────────────────────────────────────────────────────────────
// WIDGET: Guida Visiva Misurazioni (Accordion Premium)
// ─────────────────────────────────────────────────────────────────────────────
class _MeasurementGuide extends StatefulWidget {
  const _MeasurementGuide();

  @override
  State<_MeasurementGuide> createState() => _MeasurementGuideState();
}
...
class _MeasurementGuideState extends State<_MeasurementGuide>
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _expanded ? 'Tocca per nascondere' : 'Tocca per mostrare',
  ...
  Widget _buildGuideContent() {
    return Padding(
      ...
      child: Column(
        children: [
          // ── Immagine con overlay e punti annotati ───────────────
          ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                // Badge "Guida Visiva" in alto a destra
                Positioned(
                  top: 10,
                  right: 10,
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: const [
                        Icon(Icons.straighten_rounded,
                            color: AppTheme.legsAccent, size: 12),
                        SizedBox(width: 4),
                        Text(
                          'Guida Visiva',
                          style: TextStyle(
          ...
          // ── Chip con punti chiave ───────────────────────────────
          Wrap(
            spacing: 8,
            runSpacing: 8,
            alignment: WrapAlignment.center,
            children: const [
              _TipChip(label: 'Vita', hint: 'punto più stretto'),
              _TipChip(label: 'Fianchi', hint: 'max glutei'),
              _TipChip(label: 'Petto', hint: 'sotto le ascelle'),
              _TipChip(label: 'Bicipite', hint: 'braccio rilassato'),
              _TipChip(label: 'Coscia', hint: 'metà coscia'),
              _TipChip(label: 'Collo', hint: 'sotto il pomo'),
            ],
          ),
        ],
      ),
...
class _TipChip extends StatelessWidget {
  final String label;
  final String hint;
  const _TipChip({required this.label, required this.hint});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.legsAccent.withOpacity(0.1),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: AppTheme.legsAccent.withOpacity(0.3),
          width: 1,
        ),
      ),
      child: Row(
