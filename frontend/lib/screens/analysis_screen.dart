...
class _AnalysisScreenState extends State<AnalysisScreen> {
  ...
  Future<void> _generateAIReport() async {
    ...
    try {
      ...
      final biometrics = DatabaseService.getBiometricHistoryForAIJson();
      final workouts   = DatabaseService.getWorkoutHistoryForAIJson(8);

      final responseText = await ApiService.analyzePerformance(
      ...
      setState(() {
        _aiResponse = responseText.isNotEmpty ? responseText : 'Nessuna risposta dal modello.';
      });
    } catch (e) {
